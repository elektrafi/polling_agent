...
USER = "EFIADMIN"
PASSWORD = "EFI_Buna2020!1"

USE_SSL = True

VERBOSE = (
    False  # Whether to print API conversation width the router. Useful for debugging
)

VERBOSE_LOGIC = "OR"  # Whether to print and save verbose log to file. AND - print and save, OR - do only one.
VERBOSE_FILE_MODE = (
    "w"  # Weather to create new file ('w') for log or append to old one ('a').
)


CONTEXT = (
    ssl.create_default_context()
)  # It is possible to predefine context for SSL socket
    ...
    def open_socket(self):
        ...
        try:
            ...
            raise CreateSocketError(
                "Error: API failed to connect to socket. Host: {}, port: {}.".format(
